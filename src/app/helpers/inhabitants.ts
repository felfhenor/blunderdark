...
export function inhabitantDeserialize(
  ...
  return data.map((i) => {
    ...
    instanceStatBonuses: ((i as Record<string, unknown>)['mutationBonuses'] as InhabitantInstance['instanceStatBonuses']) ?? i.instanceStatBonuses ?? undefined,
    mutationTraitIds: i.mutationTraitIds ?? undefined,
    mutated: i.mutated ?? false,
    isHybrid: i.isHybrid ?? false,
    hybridParentIds: i.hybridParentIds ?? undefined,
    instanceTraitIds: i.instanceTraitIds ?? undefined,
